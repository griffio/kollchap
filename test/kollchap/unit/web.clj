...
(def meditation-room-fixture {:id 7 :name "Meditation Room" :description "This room was originally a meditation room..."})
...
(fact "create a room"
      (let [resp (request :post "/kollchap/rooms"
                          :content-type "application/json"
                          :body meditation-room-fixture)]
        (:status resp) => 201
        (get-in resp [:body :room]) => meditation-room-fixture)))
