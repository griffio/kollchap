(defproject kollchap "1.0.0-SNAPSHOT"
  :description "Kollchap service"
  ...
  :rpm {:name "kollchap"
        :summary "RPM for Kollchap service"
        ...
        :mappings [{:directory "/usr/local/kollchap"
                    :filemode "444"
                    :username "kollchap"
                    :groupname "kollchap"
                    :sources {:source [{:location "target/kollchap.jar"}]}}
                   {:directory "/usr/local/kollchap/bin"
                    :filemode "744"
                    :username "kollchap"
                    :groupname "kollchap"
                   ...
                   {:directory "/etc/rc.d/init.d"
                    :filemode "755"
                    :sources {:source [{:location "scripts/service/kollchap"
                                        :destination "kollchap"}]}}]}
